...
//           {isclicked ? (
//             <div className={`interact-tab flex flex-col justify-start items-center gap-1`} >
//               <div className={closesymb} onClick={handleClick}>
//                 {<img className='w-[2vw] hover:border-2 hover:border-orange-800' src={menu}></img> && (maxwidth > 800)}
//               </div>
