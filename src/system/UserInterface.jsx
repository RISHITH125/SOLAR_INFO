  ...
  return (
    <div className={`UserInter`}>
        <div className={`interact text-white font-bold from-neutral-50`} >
          {isclicked ? (
            <div className={`interact-tab flex flex-col justify-start items-center gap-5`} >
              <div className={`Close cursor-pointer w-[28.5vw] flex flex-row justify-end`} onClick={handleClick}>
                <img className='w-[2vw] hover:border-2 hover:border-orange-800' src={menu}></img>
              </div>
              <div className="w-[26vw] h-[90vh] text-white flex flex-col justify-start items-center gap-5">
