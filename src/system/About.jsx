...
export default function About() {
  const gradientStyles = [
    {backgroundImage:`linear-gradient(to left, transparent, #F68A06`}, // For the second profile (sun color)
  ...
  return (
    <div className='overflow-scroll overflow-x-hidden w-[100vw] h-[100vh] flex flex-col items-start pl-11 pr-14 sm:ml-7 gap-6'>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <Profile url="./system/profilessss/rahul.jpg" alt="" data-content="" link1="" link2="" link3="" rotate="0" styles={gradientStyles[2]} />
      </div>
    </div>
  );
}